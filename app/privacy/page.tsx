    ...
    <div className="container max-w-screen-lg mx-auto my-20">
      <div className="mx-4 md:mx-0 text-justify md:text-left">
        ...
        <p className="text-gray-600 my-2">
          En Farmacia Zulmita, valoramos y respetamos tu privacidad. Esta
          Política de Privacidad describe cómo recopilamos, utilizamos y
          protegemos la información que nos proporcionas al utilizar nuestro
          sitio web.
        </p>
        ...
        <p className="text-gray-600 my-2">
          ...
          personal identificable, como tu nombre, dirección de correo
          electrónico, número de teléfono y dirección postal. También podemos
          recopilar información no identificable, como tu dirección IP,
          navegador web, sistema operativo y páginas visitadas.
        </p>
        <h2 className="font-semibold text-gray-800 mt-2">
        ...
        <p className="text-gray-600 my-2">
          Nos comprometemos a proteger la seguridad de tu información personal y
          a tomar las medidas necesarias para evitar el acceso no autorizado, el
          uso indebido o la divulgación de tus datos. Utilizamos medidas de
          seguridad físicas, electrónicas y administrativas para proteger tu
          información contra pérdidas, robos y accesos no autorizados.
        </p>
        <h2 className="font-semibold text-gray-800 mt-2">
        ...
        <p className="text-gray-600 my-2">
          ...
          no están controlados por nosotros. No somos responsables de las
          prácticas de privacidad o el contenido de estos sitios web, por lo que
          te recomendamos revisar las políticas de privacidad de estos sitios
          antes de proporcionarles tu información personal.
        </p>
        <h2 className="font-semibold text-gray-800 mt-2">
        ...
        <p className="text-gray-600 my-2">
          ...
          info@farmaciazulmita.com o 222-5555.
        </p>
        <p className="text-gray-600 my-2">
          Gracias por confiar en Farmacia Zulmita para tus necesidades de salud
          y bienestar.
        </p>
