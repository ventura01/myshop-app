...
const CTAsection = (props: Props) => {
  return (
    <section id="calltoaction" className="py-20 relative overflow-hidden bg-secondary z-10">
        ...
        <div className="flex flex-col gap-y-10 sm:gap-y-5 sm:max-w-lg lg:mx-auto mx-4">
          <div className="">
            <p className="text-teal-50 font-semibold text-justify text-lg tracking-tight">
              Estamos comprometidos con tu bienestar. Descubre una amplia gama
              de productos farmacéuticos de calidad diseñados para satisfacer
