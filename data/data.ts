...
export const servicesContent = {
  heading: {
    ...
    description:
      "Ofrecemos una amplia variedad de productos farmacéuticos de alta calidad, desde medicamentos recetados hasta productos de venta libre y artículos de cuidado personal. Ya sea que estés buscando alivio para un resfriado común, controlar una condición crónica o simplemente mejorar tu bienestar general, tenemos todo lo que necesitas bajo un mismo techo.",
  },
  items: [
    {
      icon: "/icon-5.svg",
